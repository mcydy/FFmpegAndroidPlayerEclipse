	...
	while (av_read_frame(pFormatCtx, &packet) >= 0)
	{
		...
		if (packet.stream_index == videoStream)
		{
			...
			if (frameFinished)
			{
				...
				glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, videoWidth, videoHeight, GL_RGB, GL_UNSIGNED_BYTE, pFrameRGB->data[0]);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_fuchao_ffmpegandroidplayer_VideoPlayer_play(JNIEnv *env, jobject jobj)
{
	return 1;
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_fuchao_ffmpegandroidplayer_VideoPlayer_pause(JNIEnv *env, jobject jobj)
{
	return 0;
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_fuchao_ffmpegandroidplayer_VideoPlayer_stop(JNIEnv *env, jobject jobj)
{
	return 0;
}
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_fuchao_ffmpegandroidplayer_VideoPlayer_seek(JNIEnv *env, jobject jobj, jlong time)
{
	return 0;
}
